                            ...
                            <form role="form" method="post" action="{{ route('admin.product.store') }}">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="slug" type="text" value="{{ old('name') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="price" type="text" value="{{ old('name') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="discount_price" type="text" value="{{ old('name') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="short_description" type="text" value="{{ old('name') }}"
